public interface Ligne {
    ...
    /** Position de caractère dans la ligne */
    /*@ pure */ int getCurseur();

    /** le ieme cractère de la ligne
     *  @param i l'indice du caractère
     *  @return le ieme caractère de la ligne
     */
    //@ requires 1<= i && i <= getLongueur();
    /*@ pure */ char ieme(int i);

    /** Le cractère sous le curseur 
     */
    //@ requires getCurseur() > 0; // la ligne est non vide
